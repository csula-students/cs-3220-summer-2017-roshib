...
public class CustomerHeader extends SimpleTagSupport {
	public void doTag() throws JspException, IOException {
		...
		out.println("<nav> ");
		out.println("<a class=\"headList\" href=\"http://localhost:8080/customerFoodList\">Menu</a>");
		out.println("<a class=\"headList\" href=\"http://localhost:8080/customerCart\">Order</a>");
		out.println("<a class=\"headList\" href=\"http://localhost:8080/customerOrderStatus\">Statuses</a>");
		out.println("</nav> ");
		out.println("</section> ");
		out.println(" </header> ");

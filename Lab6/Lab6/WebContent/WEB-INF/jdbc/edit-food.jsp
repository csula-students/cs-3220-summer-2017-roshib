<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ taglib uri="/WEB-INF/jdbc/adminHeader.tld" prefix="ex"%>
<%@ taglib uri="/WEB-INF/jdbc/adminFooter.tld" prefix="exe"%>
...
<body>
	...
	<main> <section class="order"> <label
		class="orderLable">Editing Food</label>
	<table class="" id="">
		<thead class="">
			<tr>
				<th
		...
		<tbody>
			<tr>
				<Form method="post">
				<td><input type="text" name="name" value="${item.getName()}"> </input></td>
				<td><input type="text" name="price" value="${item.getPrice()}"> </input></td>
				<td><input type="text" name="description" value="${item.getComment()}">
					</input></td>
				<td><input type="text" name="image" value="${item.getImage()}"> </input>

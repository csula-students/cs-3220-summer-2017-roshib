<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ taglib uri="/WEB-INF/jdbc/customerHeader.tld" prefix="cx"%>
<%@ taglib uri="/WEB-INF/jdbc/customerFooter.tld" prefix="cxc"%>
		...
		<tbody>
			<c:forEach items="${entries_cart}" var="item">
				<tr>
					...
					<td><form method="get">
							<button name="Delete" value="${item.getName()}">Delete</button>
						</form></td>
				</tr>
			</c:forEach>
		</tbody>

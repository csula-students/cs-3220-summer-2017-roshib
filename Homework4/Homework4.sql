...
INSERT INTO food_items (id, food_name,price,description,image) VALUES (4, 'Pepperoni Stromboli','$9.89','Italian','http://samandlouiespizza.com/wp-content/uploads/2016/11/Capture0003-4-1-300x200.jpg');
...
INSERT INTO orders (id,customer_name,statuse,created) 
VALUES (2,'Bhupen','IN_QUEUE','2017-08-11');
...
select * from order_foods join orders where order_foods.order_id=orders.id;

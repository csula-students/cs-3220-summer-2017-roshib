<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ taglib uri="/WEB-INF/homework4/customerHeader.tld" prefix="cx"%>
<%@ taglib uri="/WEB-INF/homework4/customerFooter.tld" prefix="cxc"%>
		...
		<tbody>
			<c:forEach items="${list}" var="item">
				<tr>
					...
					<td><form method="get">
							<button name="Submit" value="${item.getId()}">Add to
								cart</button>
						</form></td>
				</tr>
			</c:forEach>

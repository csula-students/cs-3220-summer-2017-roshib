...
public class CustomerOrderServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		getServletContext().setAttribute("entries_cart", entries_cart);
		request.getRequestDispatcher("WEB-INF/homework4/order.jsp").forward(request, response);
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		entries_cart.clear();
		request.getRequestDispatcher("WEB-INF/homework4/statuses.jsp").forward(request, response);

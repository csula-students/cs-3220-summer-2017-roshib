...
public class AdminHeader extends SimpleTagSupport {
	public void doTag() throws JspException, IOException {
		...
		out.println("<nav> ");
		out.println("<a class=\"headList\" href=\"http://localhost:8080/Lab4/adminFoodList\">Inventory</a>");
		out.println("<a class=\"headList\" href=\"http://localhost:8080/Lab4/adminCreatePanel\">Create Food</a>");
		 out.println("<a class=\"headList\" href=\"http://localhost:8080/Lab4/adminOrderStatus\">Order Status</a>");
		out.println("</nav> ");
		out.println("</section> ");
		out.println(" </header> ");

...
public class AdminFooter extends SimpleTagSupport {
    public void doTag() throws JspException, IOException {
        ...
        out.println("<footer> ");
        out.println("<div>");
        out.println("<a class=\"FooterItem\" href=\"menu.html\">Term & Conditions</a>");
        out.println("</div>");
        out.println("<div>");
        out.println("<a class=\"FooterItem\" href=\"menu.html\">Privacy Statement</a>");
        out.println("</div>");
        out.println("<div>");
        out.println("<a class=\"FooterItem\" href=\"menu.html\">Cookie Policy</a>");
        out.println("</div>");

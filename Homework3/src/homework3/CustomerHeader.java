...
public class CustomerHeader extends SimpleTagSupport {
	public void doTag() throws JspException, IOException {
		...
		out.println("<nav> ");
		out.println("<a class=\"headList\" href=\"http://localhost:8080/Homework3/customerFoodList\">Menu</a>");
		out.println("<a class=\"headList\" href=\"http://localhost:8080/Homework3/customerCart\">Order</a>");
		out.println("<a class=\"headList\" href=\"http://localhost:8080/Homework3/customerOrderStatus\">Statuses</a>");
		out.println("</nav> ");
		out.println("</section> ");
		out.println(" </header> ");
